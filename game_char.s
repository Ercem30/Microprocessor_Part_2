...
_main:                             								      //     1016 -> column value
    ...
    str  r2, [sp, #1008]           									    //     1004 -> enemy 1, row position
		...
		str  r1, [sp, #1020]  
		b	ldr_r0   		// branch bug fixed						  //      988 -> fire 2 pos, col		              							    //      984 -> enemy 2, row position
		return: b ldr_r3	            							      	//      980 -> enemy 2, col position
return2:	movs r7, #50                        								//      976 -> enemy 2, is dead
...
width:           .word 310
data:            .word 996
color1:          .word 0xFFFFFF00 //yellow
color2:          .word 0xFFFF0000 //red
color3:          .word 0xFF00FF00 //greed
color4:			 .word 0xFFFFFFFF //white
color5:			 .word 0xFF33FFFF//cyan
